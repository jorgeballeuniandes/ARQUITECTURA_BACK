pipeline { 
    ...
    environment {
        ...
        GIT_REPO = 'MISW4201-202214-Backend-Grupo34'
        ...
        stage('Gitinspector') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: env.GITHUB_TOKEN_ID, passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                    ...
                    sh('git pull https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/MISW-4201-ProcesosDesarrolloAgil/${GIT_REPO} develop')
                    sh('git push https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/MISW-4201-ProcesosDesarrolloAgil/${GIT_REPO} develop')
                }  
            }
        }
